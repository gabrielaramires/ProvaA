...
input[type=button], input[type=submit], input[type=reset]  {
  ...
  text-transform: uppercase;
  font-size: 13px;
  -webkit-box-shadow: 0 10px 30px 0 rgba(152,251,152,0.99);
  box-shadow: 0 10px 30px 0 rgba(152,251,152,0.99);
...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <form method="post" action="login.php">
      <input type="text" id="cpf" class="fadeIn second" name="cpf" placeholder="CPF" maxlength="11">
